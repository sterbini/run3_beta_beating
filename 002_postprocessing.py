...
jobs_df=pd.read_pickle('/eos/user/g/gsterb/run3_beta_beating/2020.10.08.18.14.55_b4_optics_31_mixed_1.8/input_jobs_df.pickle')
...
for beam in ['b1','b2']:
    ...
    output_file(f"/eos/user/g/gsterb/run3_beta_beating_plots/{beam}_1.8.html")
